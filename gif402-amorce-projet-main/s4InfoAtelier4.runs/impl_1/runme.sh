...
HD_PWD='F:/Xilinx/Projects/gif402-amorce-projet-main/s4InfoAtelier4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log atelier4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source atelier4_wrapper.tcl -notrace
