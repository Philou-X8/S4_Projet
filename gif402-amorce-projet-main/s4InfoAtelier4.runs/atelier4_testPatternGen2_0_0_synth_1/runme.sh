...
HD_PWD='F:/Xilinx/Projects/gif402-amorce-projet-main/s4InfoAtelier4.runs/atelier4_testPatternGen2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atelier4_testPatternGen2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atelier4_testPatternGen2_0_0.tcl
