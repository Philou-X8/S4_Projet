...
end atelier4_wrapper;

architecture STRUCTURE of atelier4_wrapper is
  component atelier4 is
  port (
    reset_rtl : in STD_LOGIC;
    sys_clk : in STD_LOGIC;
    DDR_cas_n : inout STD_LOGIC;
